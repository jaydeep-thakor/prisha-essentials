    ...
    return (
        <section className='section'>
            ...
            <div className='wrapper text-center'>
                ...
                <h1 className='font-cg text-[38px] sm:text-[52px] md:text-[62pxs] leading-[1.12] text-secondary max-w-[17ch] mx-auto mb-6'>Incense, made the <span className='italic text-primary'>slow</span> way.</h1>
                ...
                <Link to="/" className='inline-block bg-secondary hover:hover-bg-secondary text-white text-sm px-9 py-3.5 rounded-full transitions-colors'>Explore Fragrances</Link>
